...
--}}
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            @if(Auth::user()->credencializacion_fotografia !== 'foto')
                                <img class="img-profile rounded-circle" src="{{ Auth::user()->credencializacion_fotografia }}">
                            @else
                                <i class="fa fa-user"></i>&nbsp;&nbsp;
                            @endif
                            <span class="d-none d-lg-inline text-gray-600 small">{{ Auth::user()->nombres.' '.Auth::user()->apellido_paterno }}</span>
                        </a>
