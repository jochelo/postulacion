...
@section('content')
    ...
    <div class="col-12">
        <br>
        <h4>Lista de<strong>Test</strong></h4>
    </div>
                    ...
                    <td>
                        <div class="btn-group">
                            <a class="btn btn-border-none btn-sm btn-outline-success "
                               href="{{ url('tests/'.$test->test_id.'/edit') }}" data-toggle="tooltip"
                               data-placement="top" title="Editar">
                                <span class="fa fa-pencil-alt"></span>
                            </a>
                            <form class="float-right" action="{{ route('tests.destroy',$test->test_id)}}" method="POST"
